...
<template>
    <div v-if="open" class="fixed w-full h-full top-0 left-0 flex items-center justify-center z-10">
      ...
      <div class="absolute max-h-full" :class="maxWidth">
        <div class="container bg-white overflow-hidden md:rounded">
          <div class="px-4 py-3 leading-none flex justify-between items-center font-medium text-sm bg-gray-100 border-b select-none">
            <h3>{{ title }}</h3>
